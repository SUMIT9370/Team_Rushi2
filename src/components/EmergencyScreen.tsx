      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto p-6 space-y-6">
          ...
          {!emergencyActivated ? (
            <Card className="p-8 bg-white border-4 border-red-500 shadow-xl">
              <div className="text-center space-y-6">
                ...
                <div>
                  <h3 className="text-3xl text-gray-900 mb-2">Need Immediate Help?</h3>
                  <p className="text-lg text-gray-600">
                    Press the emergency button to instantly alert your contacts and share your location
                  </p>
                </div>
                <Button
            ...
            <Card className="p-8 bg-green-50 border-4 border-green-500 shadow-xl">
              <div className="text-center space-y-6">
                ...
                <div>
                  <h3 className="text-3xl text-green-900 mb-2">Help is on the way!</h3>
                  <p className="text-lg text-gray-600">Your emergency contacts have been notified</p>
                </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Dialog open={isAddingContact} onOpenChange={setIsAddingContact}>
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader>
                    <DialogTitle className="text-2xl">Add Emergency Contact</DialogTitle>
                  </DialogHeader>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h4 className="text-xl text-gray-900">{contact.name}</h4>
                        {contact.isPrimary && (
                      ...
                      <p className="text-base text-gray-600">{contact.relation}</p>
          ...
          <Card className="p-6 bg-blue-50 border-blue-200">
            <h3 className="text-xl text-blue-900 mb-4">Emergency Guidelines</h3>
            <ol className="space-y-3 text-base text-gray-700">
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-7 h-7 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm">1</span>
                <span>Press the Emergency Alert button above to notify all contacts</span>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-7 h-7 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm">2</span>
                <span>Your location will be shared automatically with emergency contacts</span>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-7 h-7 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm">3</span>
                <span>For life-threatening emergencies, call 911 immediately</span>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-7 h-7 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm">4</span>
